...
const api = axios.create({
  baseURL: 'https://thanapol-backend-ebctd7d0ayh2cmf4.southeastasia-01.azurewebsites.net/api',
...
const FUNCTION_API_URL = 'https://hengfunctioncontent-cygzaef3axbwdsav.southeastasia-01.azurewebsites.net/api';
